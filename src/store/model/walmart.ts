...
export const Walmart: Store = {
  ...
  links: [
    ...
    },
    {
      ...
      url: 'https://www.walmart.com/ip/POKEMON-2024-WMD82-AE-EMPOLEON-TIN/5642776198?sid=f775eb3f-4346-4fa3-9837-650f5cdef13f',
      maxPrice: 20,
    },
    {
      brand: 'pokemon',
      model: 'tin',
      series: 'Evolving Skies',
      url: 'https://www.walmart.com/ip/POKEMON-2024-WMD82-AE-TYRANITAR-TIN/5858371608?sid=244af3a1-b254-4172-8f20-77f4b753acd4',
      maxPrice: 20,
    },
  ],
  name: 'walmart',
