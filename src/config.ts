...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      'Prismatic Evolution': envOrNumber(process.env.MAX_PRICE_SERIES_PRISMATIC_EVOLUTIONS),
      'Evolving Skies': envOrNumber(process.env.MAX_PRICE_SERIES_EVOLVING_SKIES),
    },
  },
